...
void gamePreparation(const char* mapName, const char* statusName, const char* orderName, int time = 5);
void entryPreparation(int argc, char **argv);
    ...
    try
    {
        switch(argc)
        {
            ...
            case 4:
            {
                ...
                gamePreparation(mapName, statusName, orderName);
                break;
            }
            case 5:
            {
                ...
                gamePreparation(mapName, statusName, orderName, timeOut);
                break;
            }
            default:
            {
...
void gamePreparation(const char* mapName, const char* statusName, const char* orderName, int time)
{
